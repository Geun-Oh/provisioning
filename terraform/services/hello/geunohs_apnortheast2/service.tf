...
module "hello" {
  ...
  domain_name = "hello_prod"

  # Route53 variables
  acm_external_ssl_certificate_arn = var.r53_variables.id.star_nohv_site_acm_arn_apnortheast2
  route53_external_zone_id         = var.r53_variables.id.nohv_site_zone_id
